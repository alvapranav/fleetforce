    ...
    <div className='map-controls'>
      ...
      <div className='dropdowns'>
        <div className='dropdown-child'>
          <h5>Map Style:</h5>
          <Select defaultValue="https://api.maptiler.com/maps/basic-v2/style.json?key=oGOTJkyBZPxrLa145LN6" style={{ width: '120px', height: '30px' }} onChange={(e) => onChangeMapStyle(e.target.value)} disabled={examineStop}>
